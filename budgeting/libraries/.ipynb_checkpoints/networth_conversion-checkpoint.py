...
def build(expense_report_dict):
    ...
    for year in sorted_years:
        ...
        for month in sorted_months:
            ...
            networth_dict[year_month][budgeting_constants.NET_KEY] = net_amount
            networth_dict[year_month][budgeting_constants.GAIN_KEY] = gain_amount
            networth_dict[year_month][budgeting_constants.COST_KEY] = cost_amount
